...
export function createCaptioningView(videoElement) {
    ...
    const snapshotBtn = createElement('button', { className: 'rt-overlay-btn', attributes: { title: 'Save snapshot' } });
    snapshotBtn.innerHTML = '<svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M9 2L7.17 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2h-3.17L15 2H9zm3 15a5 5 0 110-10 5 5 0 010 10z"/></svg>';
